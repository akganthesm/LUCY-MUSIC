...
async def play(_, message: Message):
    ...
    try:
        ...
        user.first_name = "LUCY MUSIC  AUTOBOT"
    usar = user
    wew = usar.id
    try:
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/da93a1e734f33b6a01e91.jpg"
    ...
    if int(chat_id) in ACTV_CALLS:
        ...
        await message.reply_photo(
            photo="final.png",
            reply_markup=keyboard,
            caption="**LUCY MUSIC AUTOBOT PLAYING SONG...**".format(),
           )
...
async def pause(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://telegra.ph/file/da93a1e734f33b6a01e91.jpg", 
                             caption="**LUCY MUSIC PAUSED SONG ...**"
    )
...
async def resume(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://telegra.ph/file/da93a1e734f33b6a01e91.jpg", 
                             caption="**LUCY MUSIC AUTOBOT PLAYING THE SONG ...**"
    )
...
async def skip(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://telegra.ph/file/da93a1e734f33b6a01e91.jpg", 
                             caption=f'**LUCY MUSIC SKIP YOUR SONG ...**'
   ) 
...
async def stop(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://telegra.ph/file/da93a1e734f33b6a01e91.jpg", 
                             caption="**LUCY MUSIC TERMINATE THE SONG ...**"
    )
